...
ul.css-uploadlist li.css-file-info {
  display: block;
  padding: 0;
  margin-left: 0;
  text-decoration: none;
...
ul.css-uploadlist li.css-file-info a.css-link {
  /* text-shadow: 2px 2px 2px #000; */
...
ul.css-uploadlist li.css-file-info a.css-link:hover {
  color: #7db72f;
}
#css-delete-notice {
  color: #414141;
...
#css-content .css-draw-attention {
  font-weight: bold;
}
.css-interactive {
  color: #414141;
...
.css-drop .css-area {
  ...
  padding: 20px;
  border-radius: 5px;
  border: 3px dashed #C11B17;
}
.css-drop .css-drop-container {
  float: left;
}
.css-drop .css-drop-container .css-file-zone {
  cursor: pointer;
}
.css-drop .css-share-container {
  float: left;
}
.css-drop .css-share-container .css-tall.css-area.css-interactive {
  overflow: visible;
}
.css-drop .css-share-container .css-id {
  display: none;
}
.css-drop .css-share-container .css-area {
  width: 260px;
}
.css-draggable {
  width: 20px;
  ...
  padding: 20px;
  border: 2px dashed #efc;
  border-radius: 5px;
  cursor: move;
}
/* 
    This snippet was stolen from min.us 
    It looks like it gets the cursor icon to be
    styleable in firefox
  */
.css-filechooser {
  background-color: white;
  position: absolute;
  /* TODO fix margins and such*/
